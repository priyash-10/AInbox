...
import { Mail, ArrowRight, Bot, Shield, Sparkles, BarChart, Clock, User, Check } from "lucide-react";
  ...
  const steps = [
    {
      ...
      description: 'New emails arrive in your inbox and are intercepted by our system.',
    },
    {
      title: 'Classification & Analysis',
      description: 'AI analyzes content, context, and metadata to determine importance and category.',
    },
    {
      title: 'Action Extraction',
      description: 'AI identifies required actions, deadlines, and responsibilities from the email.',
    },
    {
      title: 'Smart Interface Presentation',
      description: 'System presents analyzed emails with summaries, actions, and response suggestions.',
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our collaborative AI agents work together to transform your inbox into an organized, actionable system.
          </p>
        </div>
                ...
                {index % 2 === 0 ? (
                  <>
                    ...
                    <div className="w-1/2 pl-8">
                      <p className={`text-gray-600 transition-opacity duration-500 ${activeStep >= index ? 'opacity-100' : 'opacity-30'}`}>
                        {step.description}
                      </p>
                    </div>
                  </>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="py-4 px-6 bg-white border-b">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div>
            <Button variant="outline" className="mr-3 hidden md:inline-flex" onClick={() => document.querySelector("#auth-card")?.scrollIntoView({ behavior: 'smooth' })}>
              Sign In
            </Button>
            <Button onClick={() => document.querySelector("#auth-card")?.scrollIntoView({ behavior: 'smooth' })}>
              Get Started
            </Button>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button size="lg" onClick={() => document.querySelector("#auth-card")?.scrollIntoView({ behavior: 'smooth' })}>
                Start For Free
            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow-xl overflow-hidden border border-gray-200">
              ...
              <div className="p-4 space-y-2">
                <div className="border-l-4 border-amber-500 pl-3 py-2 bg-amber-50 rounded-r-md">
                  ...
                  <p className="text-xs text-gray-500">Urgent: Action required by EOD</p>
                </div>
                ...
                <div className="border-l-4 border-purple-500 pl-3 py-2 bg-purple-50 rounded-r-md">
                  ...
                  <p className="text-xs text-gray-500">AI-generated key insights</p>
                </div>
              </div>
      ...
      <section id="features" className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Intelligent Email Management</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our AI-powered platform transforms how you handle emails with smart automation and collaborative AI agents.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-t-4 border-t-blue-500">
              <CardHeader>
                ...
                <CardDescription>
                  AI agents automatically sort and prioritize incoming emails based on content and urgency.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-t-4 border-t-amber-500">
              <CardHeader>
                ...
                <CardDescription>
                  Extract and prioritize action items from emails to ensure nothing falls through the cracks.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
            ...
            <Card className="border-t-4 border-t-purple-500">
              <CardHeader>
                ...
                <CardDescription>
                  Create appropriate response drafts based on email content and your communication style.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
      ...
      <section id="pricing" className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Choose the plan that's right for you</p>
          </div>

          <div className="flex justify-center items-center mb-10">
            <span className={`mr-3 ${!isAnnual ? "font-medium text-primary" : "text-gray-500"}`}>Monthly</span>
            ...
            <span className={`ml-3 ${isAnnual ? "font-medium text-primary" : "text-gray-500"}`}>
              Annual <span className="text-xs ml-1 bg-amber-100 text-amber-800 py-0.5 px-1.5 rounded-full">Save 20%</span>
            </span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((plan, index) => (
              <div key={index} className={`border rounded-lg overflow-hidden ${plan.popular ? "border-primary shadow-lg relative" : "border-gray-200"}`}>
                {plan.popular && (
                ...
                <div className="p-6">
                  ...
                  <div className="mb-6">
                    ...
                    {plan.price.monthly > 0 && <span className="text-gray-500">/month</span>}
                    {isAnnual && plan.price.monthly > 0 && <p className="text-sm text-gray-500">Billed annually</p>}
                  </div>
                  <Button 
                    className={`w-full ${plan.popular ? "" : "bg-gray-100 text-gray-900 hover:bg-gray-200"}`}
          ...
          <div className="max-w-md mx-auto">
            <Card className="border-none shadow-lg">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl">Get Started with AInbox</CardTitle>
                <CardDescription>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">Reviews</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">&copy; 2025 AInbox. All rights reserved.</p>
